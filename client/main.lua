...
exports('GetMaps', function() return Config.Maps or {} end)


-- Events
RegisterNetEvent('enyo-rts:showRTS')
AddEventHandler('enyo-rts:showRTS', function()
...
RegisterNetEvent('rts:restoreFocus', function()
    SetNuiFocus(true, true)
    SetNuiFocusKeepInput(false)
end)

RegisterNetEvent('rts:hideUI', function()
